...
(defun inverse-isas (frame)
  (let ((class (and (classp frame) (class-of frame))))
...
(defun find-propagatep (rel-frames)
  (pa-frame-propagatep
   (name-to-frame-type
    (class-of (if (consp rel-frames) (car rel-frames) rel-frames)))))
...
(defun rename-frame (oldname newname)
  (let ((frame-class (class-of oldname)))
